...
\end{proposition}
\begin{proof}
  \uses{lem:find_multiples,lem:good_d,lem:mertens1,lem:basic,lem:divisor_bound,def:rec_sum_local}
...
\end{proposition}
\begin{proof}
  \uses{lem:find_multiples,lem:good_dlem:basic,def:rec_sum_local}
...
\end{proposition}
\begin{proof}
\uses{prop:tech_iterative,lem:pisq,prop:fourier,prop:tech_iterative2}
