...
\begin{theorem}[Solution in sets of positive density]\label{th:density_theorem}\uses{lem:sieve2,prop:techmain,lem:turan,lem:mertens1}
\leanok
...
\begin{theorem}[Solution in sets of positive logarithmic density, quantitative version]\label{th:log_density_theorem}\uses{lem:sieve1,cor:tech_cor,lem:mertens1,lem:turan}
\leanok
...
\begin{lemma}[Sieve Estimate 1]\label{lem:sieve1}\uses{lem:sieve_eratosthenes,lem:mertens2}
\leanok
...
\begin{lemma}[Sieve Estimate 2]\label{lem:sieve2}\uses{lem:sieve1}
